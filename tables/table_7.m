...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% THIS CODE GENERATES TABLE 7 IN THE PAPER
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Loading solutions for the different versions
PC = ones(4,5);
CL = ones(4,5);
...
diary 'tables/table_7.txt'

fprintf('\n')
fprintf('\n')
fprintf('    TABLE 7. PHILLIPS MULTIPLIERS AT DIFFERENT INFLATION \n')
fprintf('             RATES AND NOISE PARAMETERS                  \n')
fprintf('\n')
fprintf('    **************************************************** \n')
...
%     slope_pc(j,1)  = sum(sol_irf.irf.pinflation)/sum(sol_irf.irf.labor) ;
% end
% 
% xx = [1 2 3 4 5] ;
% 
...
% savefig('figures/figs/fig_multiplier.fig')
% print(f,[pwd '/figures/pdfs/fig_multiplier.pdf'],'-dpdf')
